...
<html>
	<head>
		...
		<title><env:get key="app.name"/> - Página não encontrada</title>
	...
	<body>		
		<div id="error_page" class="container">
			<div class="hero-unit">
		    	<h1><img src="${pageContext.request.contextPath}/img/logo-login.png" class="img-polaroid">Oops, erro 404!!!</h1>
		        <p>Desculpe, esta página não existe. Talvez ela tenha sido movida ou a URL esteja incorreta.</p>
