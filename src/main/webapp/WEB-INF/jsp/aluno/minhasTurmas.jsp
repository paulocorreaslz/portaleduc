	...
	<tbody>
		<c:forEach items="${page.content}" var="turma">
			<tr>
				...
				<th>
				<a href="${pageContext.request.contextPath}/turma/info/${turma.id}" class="btn btn-small" title="Exibir"><i class="icon-file"></i></a>
				</th>
...
<vrb:paginationLinks uri="/aluno/paginateTurmas/" page="${page}" params="aluno"/>
