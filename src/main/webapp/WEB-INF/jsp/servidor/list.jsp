...
<form class="form-inline" action="${pageContext.request.contextPath}/servidor/busca" method="post">
	...
	<tbody>
		<c:forEach items="${page.content}" var="servidor">
			<tr>
				...
				<td class="actions">
					<a href="${pageContext.request.contextPath}/aluno/novo/${servidor.id}/${turma.id}" class="btn btn-small" title="Cadastrar aluno"><i class="icon-plus-sign"></i></a>					
...
<a href="${pageContext.request.contextPath}/aluno/novoAlunoExterno/${turma.curso.id}" class="btn"><i class="icon-plus"></i> Adicionar Aluno Externo</a> 
